...
# vc_ast.py
#
# AST Node classes for the OpenCL kernel language
#
...
class NodeVisitor(object):
    """ A base NodeVisitor class for visiting vc_ast nodes.
        For example:
        ...
        *   Modeled with Python's own AST visiting facilities
    """
    def visit(self, node):
        """ Visit a node.
        """
